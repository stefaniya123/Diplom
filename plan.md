...
5.  Убедиться, что отображается уведомление об успешной операции:  
    > **Успешно. Операция одобрена Банком.**

### Сценарий 2: Отказ в оплате картой (Покупка)
1.  Открыть страницу `/`.
2.  Нажать кнопку **"Купить"**.
3.  Заполнить форму оплаты:
    ...
    *   **CVC/CVV:** `999`
4.  Нажать кнопку **"Продолжить"**.
5.  Убедиться, что отображается уведомление об отказе в операции:  
    > **Отправляем запрос в банк...**

### Сценарий 3: Успешная оплата картой (Покупка в кредит)
1.  Открыть страницу `/`.
...
### Сценарий 4: Отказ в оплате картой (Покупка в кредит)
1.  Открыть страницу `/`.
2.  Нажать кнопку **"Купить в кредит"**.
3.  Заполнить форму оплаты:
    *   **Номер карты:** `4444 4444 4444 4442`
