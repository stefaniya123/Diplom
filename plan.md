...
### Сценарий 3: Валидация пустых полей (Покупка)
- Открыть страницу `/`.
- Нажать кнопку **"Купить"**.
...
### Сценарий 4: Валидация пустых полей (Покупка в кредит)
- Открыть страницу `/`.
- Нажать кнопку **"Купить в кредит"**.
- **Не заполнять** поля формы.
- Нажать кнопку **"Продолжить"**.
- Убедиться, что под каждым полем отображаются те же сообщения об ошибках, что и в Сценарии 3.

### Сценарий 5: Валидация истекшего срока действия карты (Покупка)
- Открыть страницу `/`.
- Нажать кнопку **"Купить"**.
- Заполнить форму:
  - Номер карты: `4444 4444 4444 4442`
...
### Сценарий 6: Валидация истекшего срока действия карты (Покупка в кредит)
- Открыть страницу `/`.
- Нажать кнопку **"Купить в кредит"**.
...
### Сценарий 7: Выявление бага — некорректная ошибка при вводе будущей даты (11/25) (Покупка)
- Открыть страницу `/`.
- Нажать кнопку **"Купить"**.
- Заполнить форму:
  - Месяц: `11`
...
### Сценарий 8: Выявление бага — некорректная ошибка при вводе будущей даты (11/25) (Покупка в кредит)
- Аналогично Сценарию 7, но начиная с кнопки **"Купить в кредит"**.
- Цель: убедиться, что баг воспроизводится в обоих платежных сценариях.

> **Примечание**: Сценарии 1 и 2, 3 и 4, 5 и 6, 7 и 8 идентичны по действиям, но различаются начальной точкой входа (кнопка **"Купить"** или **"Купить в кредит"**). Это необходимо для проверки корректности работы обоих пользовательских путей.
